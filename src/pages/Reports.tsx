      ...
      <div style={{ padding: '8rem 5% 4rem 5%', color: '#faf6f0' }}>
        ...
        <div style={{ margin: '4px 0' }}>
          <PageEntryReveal delay={0.35} duration={1.25}>
            <h1 style={{ fontFamily: 'var(--font-display)', fontSize: '2.5rem', fontWeight: 400, color: '#1e1b19', textTransform: 'uppercase' }}>Reports</h1>
          </PageEntryReveal>
        </div>
        
        <ScrollReveal>
          <p style={{ color: 'var(--color-text-muted)', marginTop: '1rem', maxWidth: '600px', fontSize: '0.9rem', lineHeight: '1.6' }}>
            Generate and export operational performance reviews, active block coordination records, and asset integrity reports.
          </p>
        </ScrollReveal>
      </div>
    </div>
