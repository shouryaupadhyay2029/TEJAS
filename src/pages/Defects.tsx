      ...
      <div style={{ padding: '8rem 5% 4rem 5%', color: '#faf6f0' }}>
        ...
        <div style={{ margin: '4px 0' }}>
          <PageEntryReveal delay={0.35} duration={1.25}>
            <h1 style={{ fontFamily: 'var(--font-display)', fontSize: '2.5rem', fontWeight: 400, color: '#1e1b19', textTransform: 'uppercase' }}>Defects &amp; Asset Monitoring</h1>
          </PageEntryReveal>
        </div>
        
        <ScrollReveal>
          <p style={{ color: 'var(--color-text-muted)', marginTop: '1rem', maxWidth: '600px', fontSize: '0.9rem', lineHeight: '1.6' }}>
            Track and log live infrastructure defect records, ultrasonic test values, rail cracks, and point machine failures.
          </p>
        </ScrollReveal>
      </div>
    </div>
